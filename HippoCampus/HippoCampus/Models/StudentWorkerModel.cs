...
namespace HippoCampus.Models
{
    ...
    public class StudentWorkerGroupModel
    {
        public StudentWorkerGroupModel()
        { }

        public StudentWorkerGroupModel(string id, string wrkr_stdnt_first_name, string wrkr_stdnt_last_name, string wrkr_stdnt_transport, string wrkr_stdnt_availability, int groupId)
        {
            this.wrkr_stdnt_id = id;
            this.wrkr_stdnt_first_name = wrkr_stdnt_first_name;
            this.wrkr_stdnt_last_name = wrkr_stdnt_last_name;
