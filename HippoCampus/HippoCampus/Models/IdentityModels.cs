...
namespace HippoCampus.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private static async Task<ApplicationDbContext> SetDataBase(ApplicationDbContext context)
        {
            ...
            if (!context.Roles.Any(r => r.Name == "International Student"))
            {
                var store = new RoleStore<IdentityRole>(context);
                var manager = new RoleManager<IdentityRole>(store);
                var role = new IdentityRole { Id = "intr", Name = "International Student" };
        ...
        public System.Data.Entity.DbSet<HippoCampus.Models.ListItemModel> ListItem { get; set; }
        
        public System.Data.Entity.DbSet<HippoCampus.Models.InternList> InternLists { get; set; }
        public System.Data.Entity.DbSet<HippoCampus.Models.StudentWorkerModel> StudentWorker { get; set; }
        public System.Data.Entity.DbSet<HippoCampus.Models.GroupModel> Group { get; set; }
        public System.Data.Entity.DbSet<HippoCampus.Models.UserGroup> UserGroup { get; set; }
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ListItemModel>().ToTable("ListItem");
            modelBuilder.Entity<GroupModel>().ToTable("Group");
            modelBuilder.Entity<StudentLists>().ToTable("StudentLists");
        }
