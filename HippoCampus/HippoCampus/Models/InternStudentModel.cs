...
namespace HippoCampus.Models
{
    ...
    {
        public InternModel(string intr_stdnt_Id, string intr_stdnt_first_name, string intr_stdnt_last_name)
        {
            this.intr_stdnt_Id = intr_stdnt_Id;
            this.intr_stdnt_first_name = intr_stdnt_first_name;
            this.intr_stdnt_last_name = intr_stdnt_last_name;
        }
